...
class AppStyle {
  ...
  static TextStyle txtLatoLight12 = TextStyle(
    color: ColorConstant.black900,
    fontSize: getFontSize(
      13.sp,
    ),
  ...
  static TextStyle txtRajdhaniBold14 = TextStyle(
  ...
  static TextStyle txtRubikItalicLight13 = TextStyle(
  ...
  static TextStyle txtRubikRomanMedium20 = TextStyle(
    color: ColorConstant.black902,
    fontSize: (20.sp),
    fontFamily: 'Rubik',
    fontWeight: FontWeight.w500,
  ...
  static TextStyle txtRubikRomanLight12Gray601 = TextStyle(
  ...
  static TextStyle txtRubikItalicLight10 = TextStyle(
    color: ColorConstant.gray600,
    fontSize: (10.sp),
    fontFamily: 'Rubik',
    fontWeight: FontWeight.w300,
  ...
  static TextStyle txtRubikRomanRegular12Black902 = TextStyle(
    color: ColorConstant.black902,
    fontSize: (12.sp),
    fontFamily: 'Rubik',
    fontWeight: FontWeight.w400,
  );
  static TextStyle txtRubikRomanMedium14Black902 = TextStyle(
    color: ColorConstant.black902,
    fontSize: (14.sp),
    fontFamily: 'Rubik',
    fontWeight: FontWeight.w500,
  ...
  static TextStyle txtRubikItalicLight12 = TextStyle(
    color: ColorConstant.gray600,
    fontSize: (12.sp),
    fontFamily: 'Rubik',
    fontWeight: FontWeight.w300,
  );
  static TextStyle txtRubikRomanRegular12WhiteA700 = TextStyle(
    color: ColorConstant.whiteA700,
    fontSize: getFontSize(
      12,
    ),
  ...
  static TextStyle txtBeVietnamProSemiBold1464 = TextStyle(
    color: ColorConstant.whiteA700,
    fontSize: getFontSize(
      14.64,
    ),
...
static TextStyle txtRubikRegular140 = TextStyle(
    color: ColorConstant.whiteA700,
    fontSize: getFontSize(
      14.sp,
    ),
  ...
  static TextStyle txtRubikMedium160 = TextStyle(
    color: ColorConstant.whiteA700,
    fontSize: getFontSize(
      16.sp,
    ),
  ...
  static TextStyle txtRubikMedium141 = TextStyle(
    color: ColorConstant.black900100,
    fontSize: getFontSize(
      14.sp,
    ),
    fontFamily: 'Rubik',
  ...
  static TextStyle txtRubikBold180 = TextStyle(
    color: ColorConstant.whiteA700,
    fontSize: getFontSize(
      18.sp,
    ),
