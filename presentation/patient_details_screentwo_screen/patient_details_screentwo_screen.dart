...
import 'package:final_grad_proj/widgets/app_bar/appbar_title.dart';
...
class DropdownButtomH_Member_Suffer extends StatefulWidget {
  const DropdownButtomH_Member_Suffer({super.key});
...
class DropdownButtomH_Chronic_illesses extends StatefulWidget {
  const DropdownButtomH_Chronic_illesses({super.key});
